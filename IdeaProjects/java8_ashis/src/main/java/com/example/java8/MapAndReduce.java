 ...
 *
 *  REDUCE - Aggregating the data -> combines the stream of elements and produce single value
 *  ex: T reduce(T identity, BinaryOperator<T> accumulator)
 *   identity: its a initial value of type T
 *   accumulator if a function to combine the two values
 *
 * */
...
public class MapAndReduce {
    public static void main(String[] args) {
        ...
        // Example: find max from a given strem of integers
